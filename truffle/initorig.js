...
function initContracts() {
  ...
  loadedContracts[constants.CONTRACTS.SALE_CLOCK_AUCTION].deployed().then(function(instance) {
    saleAddress = instance.address;
  }).catch(function(e) {
    console.log(e);
  });

  loadedContracts[constants.CONTRACTS.SIRING_CLOCK_AUCTION].deployed().then(function(instance) {
    sireAddress = instance.address;
  }).catch(function(e) {
    console.log(e);
  });

  loadedContracts[constants.CONTRACTS.GENE_SCIENCE].deployed().then(function(instance) {
